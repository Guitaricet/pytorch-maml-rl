TASK_TO_ENV = {
    'reach-v1': 'SawyerReachPushPickPlaceEnv-reach',  # added -reach
    'push-v1': 'SawyerReachPushPickPlaceEnv-push',
    'pick-place-v1': 'SawyerReachPushPickPlaceEnv-pick_place',
...
ENV_TO_TASK = {value: key for key, value in TASK_TO_ENV.items()}
